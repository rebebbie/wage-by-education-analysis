...
set.seed(111)
pop=rnorm(60000, mean=160, sd=10) # Hypothetical population
set.seed(999)
obs.sam=sample(pop,size=10) # Observed sample
boot_function=function(){
boot_s = sample(obs.sam, size=10, replace=TRUE)
return(mean(boot_s))
}
boot_X_bar = replicate(100000,boot_function()) # fake replication of samples
#95% bootstrap CI
