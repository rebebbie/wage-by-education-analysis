...
# https://data.ontario.ca/dataset/wages-by-education-level/resource/7b325fa1-e9d6-4329-a501-08cdc22a79df
# Note that the dataset has since updated since prodcing this report, which removed data about other provinces, and removed years 1997-2005.
...
# Different education levels, other education levels are subsets of the main 7 categories
EDUCATION_LEVELS = c(
  "0 - 8  years",
  "Some high school",
  "High school graduate",
